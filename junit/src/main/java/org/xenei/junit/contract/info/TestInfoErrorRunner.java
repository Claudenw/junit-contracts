...
public class TestInfoErrorRunner extends Runner {
    ...
    public Description getDescription() {
        final Description description = Description.createSuiteDescription( testInfo.getContractTestClass() );
    ...
    private Description describeCause(final Throwable child) {
        return Description.createTestDescription( testInfo.getContractTestClass(), String.format( "%s(%s)",
                testInfo.getContractTestClass().getSimpleName(), fTestClass.getSimpleName() ) );
    }
